...
<template>
	...
	<section id="docs">
		...
		<div class="text-block">
			...
			<highlightjs
				language="xml"
				code='<script defer src="https://cdn.jsdelivr.net/npm/heartslider@latest/dist/heartslider.min.js"></script>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/heartslider@latest/dist/heartslider.min.css">'
	...
	progressIndicators: {
		...
		<div class="text-block">
			<h3>Actions</h3>
			<p>
				Declare the slideshow as a constant, then run <code>pause()</code> or <code>resume()</code> to stop or start autoplay. Use the <code>next()</code>, <code>prev()</code>, and <code>goTo(&#119909;)</code> methods to manually advance the slideshow. Use <code>destroy()</code> to remove
				everything and reset the <small>DOM</small>.
			</p>
			<highlightjs
				language="javascript"
